...
const UpdateCoachForm = ({ coach, onClose, onSubmit }) => {
  ...
  useEffect(() => {
    // Pre-populate form with coach data
    setValue("name", coach.name);
    setValue("email", coach.email);
    setValue("phone", coach.phone);
    setValue("image", coach.image);
    setValue("specialization", coach.specialization);
    setValue("experience", coach.experience);
    setValue("hourlyRate", coach.hourlyRate);
    setValue("location", coach.location);
  ...
  const onFormSubmit = async (data) => {
    ...
    try {
      await onSubmit(updatedCoachData);
    } catch (error) {
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    >
                      Edit coach information for {coach.name}
                    </p>
                  </div>
                </div>
                <button
                ...
                <button
                  ...
                  className={`flex-1 px-6 py-4 rounded-2xl font-semibold transition-all duration-300 flex items-center justify-center space-x-2 ${
                    isSubmitting
                      ...
                      : "bg-gradient-to-r from-green-500 to-teal-600 text-white hover:from-green-600 hover:to-teal-700 hover:scale-105 shadow-lg hover:shadow-xl"
                  }`}
                >
                  {isSubmitting ? (
                    <>
